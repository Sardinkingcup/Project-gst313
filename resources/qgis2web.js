...
map.getView().fit([10887673.158826, -292980.238006, 13864388.571118, 1480559.678553], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Malaria Cases in Malaysia</h2>';
        return titleElement;
    })(),
